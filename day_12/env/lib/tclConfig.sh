...
# installed.
TCL_PREFIX='/Volumes/Demo/100_days/day_12/env'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Volumes/Demo/100_days/day_12/env'
...
TCL_EXTRA_CFLAGS='-ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -isystem /Volumes/Demo/100_days/day_12/env/include -fdebug-prefix-map=/var/folders/nz/j6p8yfhx1mv_0grj5xl4650h0000gp/T/abs_99lesisxvl/croot/tk_1748849401842/work=/usr/local/src/conda/tk-8.6.14 -fdebug-prefix-map=/Volumes/Demo/100_days/day_12/env=/usr/local/src/conda-prefix -pipe  -D_FORTIFY_SOURCE=2 -isystem /Volumes/Demo/100_days/day_12/env/include -mmacosx-version-min=11.1 '
...
TCL_LD_FLAGS='-Wl,-pie -Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs -Wl,-rpath,/Volumes/Demo/100_days/day_12/env/lib -L/Volumes/Demo/100_days/day_12/env/lib -headerpad_max_install_names -Wl,-search_paths_first '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Volumes/Demo/100_days/day_12/env/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Volumes/Demo/100_days/day_12/env/include'
...
TCL_PACKAGE_PATH='{/Volumes/Demo/100_days/day_12/env/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Volumes/Demo/100_days/day_12/env/lib -ltclstub8.6'
...
TCL_STUB_LIB_PATH='/Volumes/Demo/100_days/day_12/env/lib/libtclstub8.6.a'
